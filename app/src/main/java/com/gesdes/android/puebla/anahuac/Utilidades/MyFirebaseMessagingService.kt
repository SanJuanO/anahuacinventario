...
class MyFirebaseMessagingService: FirebaseMessagingService() {
    ...
    private fun sendNotification(notification: RemoteMessage.Notification?, data: Map<String, String>) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this,"Anahuac")
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel("Anahuac", CHANNEL_NAME, NotificationManager.IMPORTANCE_DEFAULT
            )
