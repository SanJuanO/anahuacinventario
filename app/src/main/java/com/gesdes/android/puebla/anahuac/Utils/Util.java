package com.gesdes.android.puebla.anahuac.Utils;
    ...
    public static void changLanguage(Context context, int language) {
        ...
        switch (language) {
            case Language.cht://繁体中文
                MyContextWrapper.newLocale = Locale.TAIWAN;
                break;
            case Language.zh://简体中文
                MyContextWrapper.newLocale = Locale.SIMPLIFIED_CHINESE;
                break;
            case Language.jp://日文
                MyContextWrapper.newLocale = Locale.JAPAN;
                break;
            case Language.kor://韩语
                MyContextWrapper.newLocale = Locale.KOREA;
                break;
            case Language.spa://西班牙
                MyContextWrapper.newLocale = new Locale("es", "ES");
                break;
            case Language.fra:
                MyContextWrapper.newLocale = Locale.FRANCE;
                break;
            case Language.en:
                MyContextWrapper.newLocale = Locale.US;
                break;
            default:
                MyContextWrapper.newLocale = Locale.US;
                break;
